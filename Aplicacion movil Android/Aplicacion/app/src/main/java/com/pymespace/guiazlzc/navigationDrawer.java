...
public class navigationDrawer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db3 = refa.getReference("usuarios").child(user.getUid()).child("Administrador");
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(usuarios == null) {
                    ...
                    if(sesion.equals("1")&&admin.equals("0"))
                    {
                    ...
                    else if(sesion.equals("1")&&admin.equals("1"))
                    {
                        txtNegocioView.setText("Vista de administrador, para modificar solo en la pagina principal");
                        txtEmailView.setText(null);
                    }
