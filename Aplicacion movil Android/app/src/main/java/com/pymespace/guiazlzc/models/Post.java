...
public class Post {
    ...
    public Post(String uid, String author, String title, String body, String email, String phone, String categoria, String imageBg, String latitud, String longitud) {
        this.uid = uid;
        this.author = author;
        this.title = title;
        this.body = body;
