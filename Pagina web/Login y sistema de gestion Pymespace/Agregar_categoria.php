...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav ">
					...
					<li class="active"><a href="Agregar_categoria.php">Agregar Categorias</a></li>
	...
	<div class="container">
		<div class="content">
			<h2>Categorias &raquo; Agregar categoria</h2>
			<hr />
			...
			<form class="form-horizontal" id="formularioAlta">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" id="categoria" class="form-control" placeholder="Farmacia" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">&nbsp;</label>
					<div class="col-sm-6">
						<input type="submit" id="botonGuardar" class="btn btn-sm btn-primary" value="Guardar categoria" >
...
<script src="js/Agregar_categoria.js"></script>
<!--===============================================================================================-->
</body>
</html>
